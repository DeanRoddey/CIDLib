...
TRawBits::SwapCard4Array(       tCIDLib::TCard4* const  pc4Data
                        , const tCIDLib::TCard4         c4Count)
{
    const tCIDLib::TCard4* const pc4End = pc4Data + c4Count;
    tCIDLib::TCard4* pc4Cur = pc4Data;
    while (pc4Cur < pc4End)
    {
        *pc4Cur = bswap_32(*pc4Cur);
        pc4Cur++;
    }
}
...
TRawBits::SwapCard8Array(       tCIDLib::TCard8* const  pc8Data
                        , const tCIDLib::TCard4         c4Count)
{
    const tCIDLib::TCard8* const pc8End = pc8Data + c4Count;
    tCIDLib::TCard8* pc8Cur = pc8Data;
    while (pc8Cur < pc8End)
    {
        *pc8Cur = bswap_64(*pc8Cur);
        pc8Cur++;
    }
}
