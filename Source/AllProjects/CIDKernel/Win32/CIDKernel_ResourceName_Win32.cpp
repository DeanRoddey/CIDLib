//
// FILE NAME: CIDKernel_ResourceName_Win32.Cpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 09/13/1998
...
// DESCRIPTION:
//
//  This file provides the Win32 specific implementation of the TKrnlRscName
//  class.
//
//
// CAVEATS/GOTCHAS:
                            ...
                            , const tCIDLib::ENamedRscTypes eType)  const
{
    ...
    if (m_pidOfName != kCIDLib::pidInvalid)
    {
        ...
        TRawStr::bFormatVal(m_pidOfName, szTmp, 64, tCIDLib::ERadices::Hex);
