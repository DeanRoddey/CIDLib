...
tCIDLib::TVoid TRemBrowserServerBase::Dispatch(const TString& strMethodName, TOrbCmd& orbcToDispatch)
{
    ...
    {
        TKeyedHashSet<TVolumeInfo, TString, TStringKeyOps> colVols(29, new TStringKeyOps, &TVolumeInfo::strVolKey);
        TKeyedHashSet<TVolFailureInfo, TString, TStringKeyOps> colFails(29, new TStringKeyOps, &TVolFailureInfo::strVolKey);
