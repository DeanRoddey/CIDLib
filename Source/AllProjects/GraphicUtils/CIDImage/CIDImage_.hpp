...
//  any needed system or third part headers, which are only used internally.
//
// CAVEATS/GOTCHAS:
//
// LOG:
...
// ---------------------------------------------------------------------------
//  Bring in any headers we only need internall
// ---------------------------------------------------------------------------
#include    "CIDMath.hpp"
