...
// ---------------------------------------------------------------------------
#include    "CIDGraphDev_MessageIds.hpp"
#include    "CIDGraphDev_PlatHelpers_.hpp"
#include    "CIDGraphDev_WndDevice_.hpp"
