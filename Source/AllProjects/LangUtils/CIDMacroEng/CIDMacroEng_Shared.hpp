...
namespace tCIDMacroEng
{
    ...
    enum class EFlowTypes
    {
     ...
     EFlowTypes eXlatEFlowTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
     const TString& strXlatEFlowTypes(const EFlowTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     tCIDLib::TBoolean bIsValidEnum(const EFlowTypes eVal);
    ...
    enum class EOpCodes
    {
     ...
     EOpCodes eXlatEOpCodes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
     const TString& strXlatEOpCodes(const EOpCodes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     tCIDLib::TBoolean bIsValidEnum(const EOpCodes eVal);
