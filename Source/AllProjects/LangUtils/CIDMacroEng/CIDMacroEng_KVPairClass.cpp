...
TMEngKVPairInfo::TMEngKVPairInfo(TCIDMacroEngine& meOwner) :
    ...
    , m_c2MethId_CopyKey(kCIDMacroEng::c2BadId)
    , m_c2MethId_CopyValue(kCIDMacroEng::c2BadId)
    , m_c2MethId_DefCtor(kCIDMacroEng::c2BadId)
    , m_c2MethId_Equal(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetKey(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetValue(kCIDMacroEng::c2BadId)
    , m_c2MethId_MatchesKey(kCIDMacroEng::c2BadId)
    , m_c2MethId_MatchesValue(kCIDMacroEng::c2BadId)
    , m_c2MethId_SameKey(kCIDMacroEng::c2BadId)
    , m_c2MethId_SameValue(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetKey(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetValue(kCIDMacroEng::c2BadId)
    , m_c2MethId_Set(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetBoolean(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetCard4(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetFloat8(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetInt4(kCIDMacroEng::c2BadId)
