...
TMEngDBConnInfo::TMEngDBConnInfo(TCIDMacroEngine& meOwner) :
    ...
    , m_c2MethId_Connect2(kCIDMacroEng::c2BadId)
    , m_c2MethId_ConnectStr(kCIDMacroEng::c2BadId)
    , m_c2MethId_DefCtor(kCIDMacroEng::c2BadId)
    , m_c2MethId_Disconnect(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetSrcList(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetSrcName(kCIDMacroEng::c2BadId)
    , m_c2TypeId_KVPair(kCIDMacroEng::c2BadId)
    , m_c2TypeId_SrcList(kCIDMacroEng::c2BadId)
...
TMEngDBStmtInfo::TMEngDBStmtInfo(TCIDMacroEngine& meOwner) :
    ...
    , m_c2EnumId_ColTypes(kCIDMacroEng::c2BadId)
    , m_c2EnumId_Errors(kCIDMacroEng::c2BadId)
    , m_c2MethId_AddBinding(kCIDMacroEng::c2BadId)
    , m_c2MethId_AddStrBinding(kCIDMacroEng::c2BadId)
    , m_c2MethId_DefCtor(kCIDMacroEng::c2BadId)
    , m_c2MethId_Execute(kCIDMacroEng::c2BadId)
    , m_c2MethId_Fetch(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetBoolCol(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetCard1Col(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetCard2Col(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetCard4Col(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetCard8Col(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetDateCol(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetInt1Col(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetInt2Col(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetInt4Col(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetInt8Col(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetName(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetStrCol(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetTimeCol(kCIDMacroEng::c2BadId)
    , m_c2MethId_IsColNull(kCIDMacroEng::c2BadId)
    , m_c2MethId_InitCtor(kCIDMacroEng::c2BadId)
