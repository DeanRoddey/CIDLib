...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tCIDMacroEng::EFlowTypes eVal)
{
...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tCIDMacroEng::EOpCodes eVal)
{
...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tCIDMacroEng::EParmDirs eVal)
{
