...
TMEngIPEPInfo::TMEngIPEPInfo(TCIDMacroEngine& meOwner) :
    ...
    , m_c2MethId_FromText2(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetAddrBytes(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetAddrType(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetAsText(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetHostName(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetOrgAddr(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetPortNum(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetPortNum(kCIDMacroEng::c2BadId)
    , m_c2MethId_Set(kCIDMacroEng::c2BadId)
    , m_c2MethId_Set2(kCIDMacroEng::c2BadId)
    , m_c2MethId_TextValCtor(kCIDMacroEng::c2BadId)
    , m_c2MethId_TextValCtor2(kCIDMacroEng::c2BadId)
    , m_c2TypeId_Errors(kCIDMacroEng::c2BadId)
    , m_c2TypeId_IPAddrTypes(kCIDMacroEng::c2BadId)
    , m_pmeciErrors(0)
    , m_pmeciIPAddrTypes(0)

    // Deprecated
    , m_c2MethId_BinValCtor(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetAddr(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetNetAddr(kCIDMacroEng::c2BadId)
{
}
...
TMEngSocketInfo::TMEngSocketInfo(TCIDMacroEngine& meOwner) :
    ...
    , m_c2TypeId_Errors(kCIDMacroEng::c2BadId)
    , m_c2MethId_DefCtor(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetDataReady(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetLocalEndPoint(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetIsBound(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetIsOpen(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetStatus(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetKeepAlive(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetLinger(kCIDMacroEng::c2BadId)
    , m_c2MethId_WaitForData(kCIDMacroEng::c2BadId)
    , m_c4ErrId_AlreadyBound(kCIDMacroEng::c2BadId)
    , m_c4ErrId_NotBound(kCIDMacroEng::c2BadId)
    , m_c4ErrId_BindFailed(kCIDMacroEng::c2BadId)
    , m_c4ErrId_AlreadyConn(kCIDMacroEng::c2BadId)
    , m_c4ErrId_AlreadyOpen(kCIDMacroEng::c2BadId)
    , m_c4ErrId_NotConn(kCIDMacroEng::c2BadId)
    , m_c4ErrId_ConnFailed(kCIDMacroEng::c2BadId)
    , m_c4ErrId_Unsupported(kCIDMacroEng::c2BadId)
    , m_c4ErrId_ConnAborted(kCIDMacroEng::c2BadId)
    , m_c4ErrId_Timeout(kCIDMacroEng::c2BadId)
    , m_c4ErrId_NetworkUnreachable(kCIDMacroEng::c2BadId)
    , m_c4ErrId_NetworkDown(kCIDMacroEng::c2BadId)
    , m_c4ErrId_NotOpen(kCIDMacroEng::c2BadId)
    , m_c4ErrId_ConnRefused(kCIDMacroEng::c2BadId)
    , m_c4ErrId_DGBufTooSmall(kCIDMacroEng::c2BadId)
    , m_c4ErrId_HostUnreachable(kCIDMacroEng::c2BadId)
    , m_c4ErrId_NameTooLong(kCIDMacroEng::c2BadId)
    , m_c4ErrId_ReadErr(kCIDMacroEng::c2BadId)
    , m_c4ErrId_SetOptErr(kCIDMacroEng::c2BadId)
    , m_c4ErrId_ShutdownErr(kCIDMacroEng::c2BadId)
    , m_c4ErrId_UnknownErr(kCIDMacroEng::c2BadId)
    , m_c4ErrId_WriteErr(kCIDMacroEng::c2BadId)
    , m_pmeciErrors(0)
{
...
TMEngStreamSocketInfo::TMEngStreamSocketInfo(TCIDMacroEngine& meOwner) :
    ...
    , m_c2MethId_ReadBuffer2(kCIDMacroEng::c2BadId)
    , m_c2MethId_ReadByte(kCIDMacroEng::c2BadId)
    , m_c2MethId_ReadByte2(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetNagle(kCIDMacroEng::c2BadId)
    , m_c2MethId_Shutdown(kCIDMacroEng::c2BadId)
...
TMEngDGramSocketInfo::TMEngDGramSocketInfo(TCIDMacroEngine& meOwner) :
    ...
    , m_c2MethId_Close(kCIDMacroEng::c2BadId)
    , m_c2MethId_DefCtor(kCIDMacroEng::c2BadId)
    , m_c2MethId_BindListen(kCIDMacroEng::c2BadId)
    , m_c2MethId_BindLocal(kCIDMacroEng::c2BadId)
    , m_c2MethId_BindForRemote(kCIDMacroEng::c2BadId)
    , m_c2MethId_Open(kCIDMacroEng::c2BadId)
    , m_c2MethId_ReadFrom(kCIDMacroEng::c2BadId)
    , m_c2MethId_SendTo(kCIDMacroEng::c2BadId)
    , m_c2MethId_SendWOL(kCIDMacroEng::c2BadId)
    , m_c2MethId_SetAllowBroadcasts(kCIDMacroEng::c2BadId)
    , m_pmeciSockInfo(0)
{
    bAddClassImport(CIDMacroEng_SockClasses::strIPEPClassPath);
}
...
TMEngSockPingerInfo::TMEngSockPingerInfo(TCIDMacroEngine& meOwner) :
    ...
    , m_c2MethId_CancelWait(kCIDMacroEng::c2BadId)
    , m_c2MethId_DefCtor(kCIDMacroEng::c2BadId)
    , m_c2MethId_EndPing(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetLastTime(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetRemAddr(kCIDMacroEng::c2BadId)
    , m_c2MethId_GetState(kCIDMacroEng::c2BadId)
    , m_c2MethId_SendRequest(kCIDMacroEng::c2BadId)
    , m_c2MethId_StartPing(kCIDMacroEng::c2BadId)
    , m_c2MethId_WaitReply(kCIDMacroEng::c2BadId)
