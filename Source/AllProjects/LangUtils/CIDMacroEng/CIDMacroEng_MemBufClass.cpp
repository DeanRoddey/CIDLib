...
TMEngMemBufInfo::TMEngMemBufInfo(TCIDMacroEngine& meOwner) :
    ...
    , m_c2MethId_FindByte(kMacroEng::c2BadId)
    , m_c2MethId_GetCard1At(kMacroEng::c2BadId)
    , m_c2MethId_GetCard2At(kMacroEng::c2BadId)
    , m_c2MethId_GetCard4At(kMacroEng::c2BadId)
    , m_c2MethId_GetFloat4At(kMacroEng::c2BadId)
    , m_c2MethId_GetFloat8At(kMacroEng::c2BadId)
    ...
    , m_c2MethId_PutFloat4At(kMacroEng::c2BadId)
    , m_c2MethId_PutFloat8At(kMacroEng::c2BadId)
    ...
    , m_c2MethId_RemoveSpace(kMacroEng::c2BadId)
