...
TTextOutStream& tCIDSock::operator<<(TTextOutStream& strmTar, const tCIDSock::EExpOpts eVal)
{
...
TTextOutStream& tCIDSock::operator<<(TTextOutStream& strmTar, const tCIDSock::EProtos eVal)
{
...
TTextOutStream& tCIDSock::operator<<(TTextOutStream& strmTar, const tCIDSock::EQualified eVal)
{
...
static TEnumMap::TEnumValItem aeitemValues_ESecureOpts[3] = 
{
    {  tCIDLib::TInt4(tCIDSock::ESecureOpts::Insecure), 0, 0,  { L"", L"", L"", L"Insecure", L"ESecureOpts::Insecure", L"" } }
  , {  tCIDLib::TInt4(tCIDSock::ESecureOpts::Secure), 0, 0,  { L"", L"", L"", L"Secure", L"ESecureOpts::Secure", L"" } }
  , {  tCIDLib::TInt4(tCIDSock::ESecureOpts::Both), 0, 0,  { L"", L"", L"", L"Both", L"ESecureOpts::Both", L"" } }

};

static TEnumMap emapESecureOpts
(
     L"ESecureOpts"
     , 3
     , kCIDLib::True
     , aeitemValues_ESecureOpts
     , nullptr
     , tCIDLib::TCard4(tCIDSock::ESecureOpts::None)
);

const TString& tCIDSock::strXlatESecureOpts(const tCIDSock::ESecureOpts eVal, const tCIDLib::TBoolean bThrowIfNot)
{
    return emapESecureOpts.strMapEnumVal(tCIDLib::TCard4(eVal), TEnumMap::ETextVals::BaseName, bThrowIfNot);
}

tCIDSock::ESecureOpts tCIDSock::eXlatESecureOpts(const TString& strVal, const tCIDLib::TBoolean bThrowIfNot)
{
    return tCIDSock::ESecureOpts(emapESecureOpts.i4MapEnumText(strVal, TEnumMap::ETextVals::BaseName, bThrowIfNot));
}

TTextOutStream& tCIDSock::operator<<(TTextOutStream& strmTar, const tCIDSock::ESecureOpts eVal)
{
    strmTar << emapESecureOpts.strMapEnumVal(tCIDLib::TCard4(eVal), TEnumMap::ETextVals::BaseName, kCIDLib::False);
    return strmTar;
}
tCIDLib::TVoid TBinInStream_ReadArray(TBinInStream& strmSrc, tCIDSock::ESecureOpts* const aeList, const tCIDLib::TCard4 c4Count)
{
    tCIDLib::TCard4 c4Cur = 0;
    for (tCIDLib::TCard4 c4Index = 0; c4Index < c4Count; c4Index++)
    {
        strmSrc >> c4Cur;
        aeList[c4Index] = tCIDSock::ESecureOpts(c4Cur);
    }
}
tCIDLib::TVoid TBinOutStream_WriteArray(TBinOutStream& strmTar, const tCIDSock::ESecureOpts* const aeList, const tCIDLib::TCard4 c4Count)
{
    for (tCIDLib::TCard4 c4Index = 0; c4Index < c4Count; c4Index++)
        strmTar << tCIDLib::TCard4(aeList[c4Index]);
}
tCIDLib::TBoolean tCIDSock::bIsValidEnum(const tCIDSock::ESecureOpts eVal)
{
    return emapESecureOpts.bIsValidEnum(tCIDLib::TCard4(eVal));
