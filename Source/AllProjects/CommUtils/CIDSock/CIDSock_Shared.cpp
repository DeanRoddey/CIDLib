...
TTextOutStream& operator<<(TTextOutStream& strmTar, const tCIDSock::ESecureOpts eVal)
{
    strmTar << emapESecureOpts.strMapEnumVal(tCIDLib::TCard4(eVal), TEnumMap::ETextVals::BaseName, kCIDLib::False);
    return strmTar;
}
TBinOutStream& operator<<(TBinOutStream& strmTar, const tCIDSock::ESecureOpts eVal)
{
    strmTar.WriteEnum(tCIDLib::TCard4(eVal));
    return strmTar;
}
TBinInStream& operator>>(TBinInStream& strmSrc, tCIDSock::ESecureOpts& eVal)
{
    eVal = tCIDSock::ESecureOpts(strmSrc.c4ReadEnum());
    return strmSrc;
}
