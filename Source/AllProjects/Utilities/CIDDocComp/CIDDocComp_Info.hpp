...
namespace tCIDDocComp
{
    ...
    // ------------------------------------------------------------------------
    //  The overall class element has a set of bitmap flags that indicate various possible attributes of that class. We can't use None for no flags since it's used to report a failure to translate a value, so we define NoFlags. XML doesn't allow an empty NMTOKENS attr so we have to have something as a default in the DTD.
    //                  
    // ------------------------------------------------------------------------
