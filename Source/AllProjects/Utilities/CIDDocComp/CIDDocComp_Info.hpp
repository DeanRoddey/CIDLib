...
namespace tCIDDocComp
{
    ...
    [[nodiscard]]  EClsFlags eXlatEClsFlags(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  const TString& strXlatEClsFlags(const EClsFlags eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const EClsFlags eVal);

    [[nodiscard]] constexpr tCIDDocComp::EClsFlags operator|(const tCIDDocComp::EClsFlags eLHS, const tCIDDocComp::EClsFlags eRHS)
    {    
    ...
    [[nodiscard]]  EGSDirs eXlatEGSDirs(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  const TString& strXlatEGSDirs(const EGSDirs eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const EGSDirs eVal);
    ...
    [[nodiscard]]  EMethAttrs eXlatEMethAttrs(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  const TString& strXlatEMethAttrs(const EMethAttrs eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     const TString& strLoadEMethAttrs(const EMethAttrs eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const EMethAttrs eVal);

    [[nodiscard]] constexpr tCIDDocComp::EMethAttrs operator|(const tCIDDocComp::EMethAttrs eLHS, const tCIDDocComp::EMethAttrs eRHS)
    {    
    ...
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const EMUTypes eVal);
    ...
    [[nodiscard]]  EPageTypes eXlatEPageTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  const TString& strXlatEPageTypes(const EPageTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     const TString& strLoadEPageTypes(const EPageTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const EPageTypes eVal);
    ...
    [[nodiscard]]  EParmPB eXlatEParmPB(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  const TString& strXlatEParmPB(const EParmPB eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const EParmPB eVal);
    ...
    [[nodiscard]]  ESpecMeths eXlatESpecMeths(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  const TString& strXlatESpecMeths(const ESpecMeths eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const ESpecMeths eVal);
    ...
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const ESrcTypes eVal);
    ...
    [[nodiscard]]  EVisTypes eXlatEVisTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  const TString& strXlatEVisTypes(const EVisTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
     const TString& strLoadEVisTypes(const EVisTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    [[nodiscard]]  tCIDLib::TBoolean bIsValidEnum(const EVisTypes eVal);
