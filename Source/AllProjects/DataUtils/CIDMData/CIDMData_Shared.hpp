...
namespace kCIDMData
{
    ...
    //                  
    // ------------------------------------------------------------------------
    const tCIDLib::TCard1 c1ChunkFlag_DataChange = 0x01;
    ...
    //                  
    // ------------------------------------------------------------------------
    const tCIDLib::TCard4 c4ChunkFlId_FileEnd = 0x470FB9A9;
    const tCIDLib::TCard4 c4ChunkFlId_FileStart = 0xA3957BE1;
    const tCIDLib::TCard1 c1ChunkFlId_ChunkStart = 0xEA;
    const tCIDLib::TCard1 c1ChunkFlId_ChunkEnd = 0xBC;
    ...
    //                  
    // ------------------------------------------------------------------------
    const tCIDLib::TCard1 c1ChunkFl_FmtVersion = 1;
    const tCIDLib::TCard4 c4ChunkFl_MaxMetaKeys = 48;
...
namespace tCIDMData
{
    ...
    CIDMDATAEXP EAttrTypes eXlatEAttrTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    CIDMDATAEXP const TString& strXlatEAttrTypes(const EAttrTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    CIDMDATAEXP tCIDLib::TBoolean bIsValidEnum(const EAttrTypes eVal);
    ...
    CIDMDATAEXP EAttrEdTypes eXlatEAttrEdTypes(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
    CIDMDATAEXP const TString& strXlatEAttrEdTypes(const EAttrEdTypes eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
    CIDMDATAEXP tCIDLib::TBoolean bIsValidEnum(const EAttrEdTypes eVal);

}

#pragma CIDLIB_POPPACK

CIDMDATAEXP TBinOutStream& operator<<(TBinOutStream& strmTar, const tCIDMData::EAttrTypes eToStream);
CIDMDATAEXP TBinInStream& operator>>(TBinInStream& strmSrc, tCIDMData::EAttrTypes& eToFill);
...
CIDMDATAEXP TBinOutStream& operator<<(TBinOutStream& strmTar, const tCIDMData::EAttrEdTypes eToStream);
CIDMDATAEXP TBinInStream& operator>>(TBinInStream& strmSrc, tCIDMData::EAttrEdTypes& eToFill);
