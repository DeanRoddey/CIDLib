//
// FILE NAME: CIDEncode_ISO8859_4.cpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 05/29/1999
...
// DESCRIPTION:
//
//  This file implements the TLatin4Converter class, which handles converting
...
// ---------------------------------------------------------------------------
AdvRTTIDecls(TLatin4Converter,TMode1EncodingBase)



namespace CIDEncode_ISO8859_4
{
    // -----------------------------------------------------------------------
    //  Local const data
    //
...
// ---------------------------------------------------------------------------
//  TLatin4Converter: Constructors and Destructor
// ---------------------------------------------------------------------------
TLatin4Converter::TLatin4Converter() :

    TMode1EncodingBase
    (
        L"ISO-8859-4"
        , CIDEncode_ISO8859_4::achFromMap
        , CIDEncode_ISO8859_4::acmToMap
        , CIDEncode_ISO8859_4::c4ToMapSize
    )
{
}

TLatin4Converter::TLatin4Converter(const TLatin4Converter& tcvtToCopy) :
...
// ---------------------------------------------------------------------------
TLatin4Converter&
TLatin4Converter::operator=(const TLatin4Converter& tcvtToAssign)
{
