//
// FILE NAME: CIDEncode_EBCDIC_037.cpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 05/29/1999
...
// DESCRIPTION:
//
//  This file implements the TEBCDIC037Converter class, which handles converting
//  the EBCDIC-CP-US (IBM037) encoding to and from the internal Unicode format.
...
// ---------------------------------------------------------------------------
AdvRTTIDecls(TEBCDIC037Converter,TMode1EncodingBase)


namespace
{
    namespace CIDEncode_EBCDIC037
    {
        // ---------------------------------------------------------------------------
        //  Local const data
        //
        ...
        //      the table, and that entry holds the equivalent Unicode value. If there
        //      is no legal external code point at that index, its set to 0xFFFF.
        //
        //  achToMap
        //      This is the table that maps from the internal Unicode encoding to the
        //      external encoding. The table is sorted by the Unicode value.
        //
        //  c1RepChar
        //      This is the replacement char, which is used to represent Unicode
        //      values that cannot be represented, if converter is set up to do that.
        //
        //  c4ToMapSize
        //      This is the number of entries in the 'to' map. Since there can be
        //      more than one Unicode value that maps to a particular external code
        //      point, its not just a 256 entry table.
        // ---------------------------------------------------------------------------
        ...
        constexpr tCIDLib::TCard1 c1RepChar = 63;
...
// ---------------------------------------------------------------------------
//  TEBCDIC037Converter: Public, static methods
// ---------------------------------------------------------------------------
tCIDLib::TCh TEBCDIC037Converter::chDecodeOne(const tCIDLib::TCard1 c1ToDecode)
{
    // Just return the mapped EBCDIC byte
    return CIDEncode_EBCDIC037::achFromMap[c1ToDecode];
}


// ---------------------------------------------------------------------------
//  TEBCDIC037Converter: Constructors and Destructor
// ---------------------------------------------------------------------------
TEBCDIC037Converter::TEBCDIC037Converter() :

    TMode1EncodingBase
    (
        L"EBCDIC-CP-US"
        , CIDEncode_EBCDIC037::achFromMap
        , CIDEncode_EBCDIC037::acmToMap
        , CIDEncode_EBCDIC037::c4ToMapSize
    )
{
}

TEBCDIC037Converter::TEBCDIC037Converter(const TEBCDIC037Converter& tcvtToCopy) :
...
// ---------------------------------------------------------------------------
TEBCDIC037Converter&
TEBCDIC037Converter::operator=(const TEBCDIC037Converter& tcvtToAssign)
{
