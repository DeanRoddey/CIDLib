//
// FILE NAME: CIDEncode_ISO8859_3.cpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 05/29/1999
...
// DESCRIPTION:
//
//  This file implements the TLatin3Converter class, which handles converting
...
// ---------------------------------------------------------------------------
AdvRTTIDecls(TLatin3Converter,TMode1EncodingBase)


namespace CIDEncode_ISO8859_3
{
    // -----------------------------------------------------------------------
    //  Local const data
    //
...
// ---------------------------------------------------------------------------
//  TLatin3Converter: Constructors and Destructor
// ---------------------------------------------------------------------------
TLatin3Converter::TLatin3Converter() :

    TMode1EncodingBase
    (
        L"ISO-8859-3"
        , CIDEncode_ISO8859_3::achFromMap
        , CIDEncode_ISO8859_3::acmToMap
        , CIDEncode_ISO8859_3::c4ToMapSize
    )
{
}

TLatin3Converter::TLatin3Converter(const TLatin3Converter& tcvtToCopy) :
...
// ---------------------------------------------------------------------------
TLatin3Converter&
TLatin3Converter::operator=(const TLatin3Converter& tcvtToAssign)
{
