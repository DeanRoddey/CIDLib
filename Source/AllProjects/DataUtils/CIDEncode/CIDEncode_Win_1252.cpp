//
// FILE NAME: CIDEncode_Win_1252.cpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 03/15/2000
...
// DESCRIPTION:
//
//  This file implements the TWin1252Converter class, which handles converting
//  the CP1252 encoding to and from the internal Unicode format. We really
...
// ---------------------------------------------------------------------------
AdvRTTIDecls(TWin1252Converter,TMode1EncodingBase)


namespace CIDEncode_Win1252
{
    // -----------------------------------------------------------------------
    //  Local const data
    //
...
// ---------------------------------------------------------------------------
//  TWin1252Converter: Constructors and Destructor
// ---------------------------------------------------------------------------
TWin1252Converter::TWin1252Converter() :

    TMode1EncodingBase
    (
        L"CP1252"
        , CIDEncode_Win1252::achFromMap
        , CIDEncode_Win1252::acmToMap
        , CIDEncode_Win1252::c4ToMapSize
    )
{
}

TWin1252Converter::TWin1252Converter(const TWin1252Converter& tcvtToCopy) :
...
// ---------------------------------------------------------------------------
TWin1252Converter&
TWin1252Converter::operator=(const TWin1252Converter& tcvtToAssign)
{
