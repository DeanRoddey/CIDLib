//
// FILE NAME: CIDEncode_PC_850.cpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 03/15/2000
...
// DESCRIPTION:
//
//  This file implements the TPC850Converter class, which handles converting
//  the PC850 encoding to and from the internal Unicode format. We really
...
namespace CIDEncode_PC850
{
    ...
    const tCIDEncode::TCharMap acmToMap[] =
    {
        ...
        , { 0x00A0, 0xFF }, { 0x00A1, 0xAD }, { 0x00A2, 0xBD }, { 0x00A3, 0x9C }
...
// ---------------------------------------------------------------------------
//  TPC850Converter: Constructors and Destructor
// ---------------------------------------------------------------------------
TPC850Converter::TPC850Converter() :

    TMode1EncodingBase
    (
        L"CP850"
        , CIDEncode_PC850::achFromMap
        , CIDEncode_PC850::acmToMap
        , CIDEncode_PC850::c4ToMapSize
    )
{
}

TPC850Converter::TPC850Converter(const TPC850Converter& tcvtToCopy) :
...
// ---------------------------------------------------------------------------
TPC850Converter&
TPC850Converter::operator=(const TPC850Converter& tcvtToAssign)
{
