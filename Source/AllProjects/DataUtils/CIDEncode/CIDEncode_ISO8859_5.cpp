//
// FILE NAME: CIDEncode_ISO8859_5.cpp
//
// AUTHOR: Dean Roddey
//
// CREATED: 05/29/1999
...
// DESCRIPTION:
//
//  This file implements the TLatin5Converter class, which handles converting
...
// ---------------------------------------------------------------------------
AdvRTTIDecls(TLatin5Converter,TMode1EncodingBase)



namespace CIDEncode_ISO8859_5
{
    // -----------------------------------------------------------------------
    //  Local const data
    //
...
// ---------------------------------------------------------------------------
//  TLatin5Converter: Constructors and Destructor
// ---------------------------------------------------------------------------
TLatin5Converter::TLatin5Converter() :

    TMode1EncodingBase
    (
        L"ISO-8859-5"
        , CIDEncode_ISO8859_5::achFromMap
        , CIDEncode_ISO8859_5::acmToMap
        , CIDEncode_ISO8859_5::c4ToMapSize
    )
{
}

TLatin5Converter::TLatin5Converter(const TLatin5Converter& tcvtToCopy) :
...
// ---------------------------------------------------------------------------
TLatin5Converter&
TLatin5Converter::operator=(const TLatin5Converter& tcvtToAssign)
{
