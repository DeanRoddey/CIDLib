...
{
    const tCIDLib::TCard4   c4Enough = 1440;
    const tCIDLib::TCard4   c4MaxD = 154;
    const tCIDLib::TCard4   c4Lens = 320;

    // -----------------------------------------------------------------------
    //  Tables for fixed table decoding
    // -----------------------------------------------------------------------
    const tCIDZLib_::TCode acdLenFix[512] =
    {
    ...
    const tCIDZLib_::TCode acdDistFix[32] =
    {
