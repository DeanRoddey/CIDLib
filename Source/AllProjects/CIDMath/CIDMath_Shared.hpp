...
//  DATE: Fri, Apr 02 17:44:00 2021 -0400
//
...
namespace tCIDMath
{
    ...
    inline tCIDMath::EGraphScales operator++(tCIDMath::EGraphScales& eVal, int)
    {
    ...
    inline tCIDMath::ELogTypes operator++(tCIDMath::ELogTypes& eVal, int)
    {
    ...
    inline tCIDMath::EMatrixElems operator++(tCIDMath::EMatrixElems& eVal, int)
    {
