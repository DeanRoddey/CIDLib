...
namespace tCIDSChan
{
    ...
    enum class EConnOpts : tCIDLib::TCard4
    {
     ...
     EConnOpts eXlatEConnOpts(const TString& strToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::False);
     const TString& strXlatEConnOpts(const EConnOpts eToXlat, const tCIDLib::TBoolean bThrowIfNot = kCIDLib::True);
...
constexpr tCIDSChan::EConnOpts operator|(const tCIDSChan::EConnOpts eLHS, const tCIDSChan::EConnOpts eRHS)
{    
